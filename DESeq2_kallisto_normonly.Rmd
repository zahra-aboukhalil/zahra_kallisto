...
pcaData <- plotPCA(vsd, intgroup = "population", returnData=TRUE)
percentVar <- round(100 * attr(pcaData, "percentVar"))
shape<- as.factor(kmeans_8$cluster)
ggplot(pcaData, aes(PC1, PC2, color=population, shape=shape, label=colnames(dds))) + geom_point(size=3) + xlab(paste0("PC1: ",percentVar[1],"% variance")) + ylab(paste0("PC2: ",percentVar[2],"% variance")) + coord_fixed()+scale_shape_manual(values=seq(0,15))+ geom_text(size=2.5, nudge_x = -2, nudge_y = 2, check_overlap = T)
...
pcaData <- plotPCA(vsd, intgroup = "population", returnData=TRUE)
percentVar <- round(100 * attr(pcaData, "percentVar"))
shape<- as.factor(kmeans_7$cluster)
ggplot(pcaData, aes(PC1, PC2, color=population, shape=shape)) + geom_point(size=3) + xlab(paste0("PC1: ",percentVar[1],"% variance")) + ylab(paste0("PC2: ",percentVar[2],"% variance")) + coord_fixed()+scale_shape_manual(values=seq(0,15))
...
pcaData <- plotPCA(vsd, intgroup = "population", returnData=TRUE)
percentVar <- round(100 * attr(pcaData, "percentVar"))
shape<- as.factor(kmeans_6$cluster)
ggplot(pcaData, aes(PC1, PC2, color=population, shape=shape)) + geom_point(size=3) + xlab(paste0("PC1: ",percentVar[1],"% variance")) + ylab(paste0("PC2: ",percentVar[2],"% variance")) + coord_fixed()+scale_shape_manual(values=seq(0,15))
...
pcaData <- plotPCA(vsd, intgroup = "population", returnData=TRUE)
percentVar <- round(100 * attr(pcaData, "percentVar"))
shape<- as.factor(kmeans_5$cluster)
ggplot(pcaData, aes(PC1, PC2, color=population, shape=shape)) + geom_point(size=3) + xlab(paste0("PC1: ",percentVar[1],"% variance")) + ylab(paste0("PC2: ",percentVar[2],"% variance")) + coord_fixed()+scale_shape_manual(values=seq(0,15))
...
pcaData <- plotPCA(vsd, intgroup = "population", returnData=TRUE)
percentVar <- round(100 * attr(pcaData, "percentVar"))
shape<- as.factor(kmeans_3$cluster)
ggplot(pcaData, aes(PC1, PC2, color=population, shape=shape)) + geom_point(size=3) + xlab(paste0("PC1: ",percentVar[1],"% variance")) + ylab(paste0("PC2: ",percentVar[2],"% variance")) + coord_fixed()+scale_shape_manual(values=seq(0,15))
```
