...
#Plot tsne
ggplot(tsne_df, aes(X1, X2, color=population, shape=condition, label=replicate)) + geom_point(size=2) + xlab("X1") + ylab("X2")+ geom_text(size=2.5, nudge_x = 0.3, nudge_y = 0.2, check_overlap = T)
