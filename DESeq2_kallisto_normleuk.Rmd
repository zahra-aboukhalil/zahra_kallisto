...
#Just LMPP-GMP AML Populations

```{r, message=FALSE}
#Filter vsd for just LMPP and GMP AML populations
vsd.LRT500_LMPP_GMP_AML<- vsd.LRT500[vsd.LRT500$conditon=="leukaemic" and vsd.LRT500$population=="LMPP",]
```
